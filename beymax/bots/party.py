...
Parties = CommandSuite('Parties')

@Parties.migration('remove parties.json')
...
@Parties.add_command('party', Arg('name', remainder=True, help="Optional party name"))
...
@Parties.subscribe('cleanup-party')
