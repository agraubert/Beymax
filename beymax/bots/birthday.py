...
Birthdays = CommandSuite('Birthdays')

@Birthdays.migration('remove birthdays.json')
...
@Birthdays.migration('ensure integer birthday ids')
...
@Birthdays.add_task(43200) #12 hours
