...
Bugs = CommandSuite('Bugs')

Bugs.reserve_channel('bugs')

@Bugs.migration('remove bugs.json')
...
@Bugs.add_command('thread', Arg('bug', type=int, help="Bug ID"), aliases=['bug:thread'])
...
@Bugs.add_command(
    'bug:user',
    Arg('bug', type=int, help="Bug ID"),
    Arg('user', type=UserType(Bugs), help="Username or ID")
)
